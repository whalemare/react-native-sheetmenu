...
class SheetMenuComponent extends React.PureComponent<Props> {
  SheetMenuComponent: Modal;
  ...
  /**
   * Open the SheetMenuComponent
   */
  open() {
    this.SheetMenuComponent.open();
  }

  /**
   * Close the SheetMenuComponent
   */
  close() {
    this.SheetMenuComponent.close();
  }
